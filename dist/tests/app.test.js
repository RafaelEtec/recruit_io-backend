...
const usuario_1 = require("../src/routes/usuario");
...
const startServer = async (mockPrisma) => {
    const app = (0, app_1.createApp)({ usuarioRouter: (0, usuario_1.createUsuarioRouter)({ prisma: mockPrisma }) });
...
describe("API endpoints", () => {
    ...
    describe("rotas de usuários", () => {
        ...
        test("cria usuário e retorna dados com senha criptografada", async () => {
            ...
            await expect(bcryptjs_1.default.compare("123456", body.senha)).resolves.toBe(true);
        });
        ...
        test("busca usuário por id", async () => {
            ...
            const usuarioId = primeiro.body.id;
        ...
        test("atualiza dados e senha do usuário", async () => {
            ...
            await expect(bcryptjs_1.default.compare("novaSenha", atualizado.senha)).resolves.toBe(true);
